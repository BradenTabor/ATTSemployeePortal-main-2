  ...
  ci: {
    collect: {
      ...
      url: [
        ...
        "http://127.0.0.1:4173/admin/requests-oversight?section=rto",
        "http://127.0.0.1:4173/admin/requests-oversight?section=jsa",
        "http://127.0.0.1:4173/admin/requests-oversight?section=parts-fixes",
