        ...
        {editing ? (
          ...
          >
            <input
              ...
              autoFocus
              className="px-3 py-2 text-base rounded-md bg-neutral-800 text-white border border-green-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500"
            />
