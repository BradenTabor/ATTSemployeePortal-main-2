...
const themeConfig = {
  emerald: {
    ...
    glow: 'rgba(47,164,90, 0.25)',
    hoverGlow: 'rgba(47,164,90, 0.5)',
    bg: 'from-emerald-500/20 to-emerald-600/30',
    gradient: 'linear-gradient(145deg, rgba(18,26,21, 0.95) 0%, rgba(11,16,13, 0.98) 100%)',
  },
  amber: {
    border: 'border-amber-400/40',
    hoverBorder: 'hover:border-amber-400/70',
    text: 'text-amber-200',
    glow: 'rgba(174,219,63, 0.25)',
    hoverGlow: 'rgba(174,219,63, 0.5)',
  ...
  blue: {
    ...
    text: 'text-blue-200',
    glow: 'rgba(125,205,162, 0.25)',
    hoverGlow: 'rgba(125,205,162, 0.5)',
