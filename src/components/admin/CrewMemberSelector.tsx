      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute z-50 mt-1 w-full max-h-64 overflow-hidden rounded-xl border border-[#E4EAE1]/20 bg-[#0B100D] shadow-[0_20px_40px_rgba(0,0,0,0.5)]"
          >
            {/* Search input */}
            <div className="sticky top-0 p-2 bg-[#0B100D] border-b border-white/5">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2 rounded-lg bg-[#040605] border border-[#E4EAE1]/10 text-white text-sm placeholder:text-white/30 focus:outline-none focus-visible:border-[#F4F7F2]/40"
                />
              </div>
            </div>
