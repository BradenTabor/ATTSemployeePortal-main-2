            ...
            <div className="sticky top-0 p-2 bg-[#0c0a07] border-b border-white/5">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2 rounded-lg bg-[#050402] border border-[#f6dcb2]/10 text-white text-sm placeholder:text-white/30 focus:outline-none focus-visible:border-[#f4c979]/40"
                />
              </div>
            </div>
