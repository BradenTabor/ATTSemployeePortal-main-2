              ...
              <div className="flex gap-2">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 top-full mt-2 w-40 bg-gray-950 border-2 border-gray-800 rounded-xl shadow-2xl shadow-black/50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-20 overflow-hidden">
                    <button onClick={() => handleExportEquipment("csv")} disabled={isExporting} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-amber-600/20 transition-colors">
                      <FileSpreadsheet className="w-4 h-4 text-amber-400" /> CSV
                    </button>
                    <button onClick={() => handleExportEquipment("excel")} disabled={isExporting} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-amber-600/20 transition-colors border-t border-gray-800">
                      <Table className="w-4 h-4 text-amber-400" /> Excel
                    </button>
                    <button onClick={() => handleExportEquipment("pdf")} disabled={isExporting} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-amber-600/20 transition-colors border-t border-gray-800">
                      <FileDown className="w-4 h-4 text-amber-400" /> PDF
                    </button>
                  </div>
                </div>
              </div>
