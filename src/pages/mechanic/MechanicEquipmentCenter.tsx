...
export default function MechanicEquipmentCenter() {
  ...
  return (
    <DashboardLayout title="Equipment Inspection Center" pageHeading>
      <div className="w-full min-h-screen bg-gradient-to-br from-[#0B100D] via-[#040605] to-[#040605]">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 pb-4 pt-4 sm:pt-6">
          ...
          <div className="mb-5 md:mb-6">
            ...
            >
              <div 
                className="relative overflow-hidden rounded-leaf-sm md:rounded-leaf border border-white/[0.08] shadow-[0_8px_32px_rgba(0,0,0,0.5)]"
                style={{
                ...
                <div className="relative px-5 py-4 md:px-7 md:py-5">
                  <div className="flex items-center gap-3 mb-3">
                    <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.4, delay: 0.2 }} className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-amber-500/15 border border-amber-500/30">
                      ...
                      <span className="text-[10px] uppercase text-amber-200 font-mono font-medium tracking-[0.14em]">Fleet Ops</span>
                    </motion.div>
                    <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.4, delay: 0.3 }} className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[#0B100D]/60 border border-amber-500/20">
                      <Wrench className="w-3 h-3 text-amber-400" />
                      <span className="text-[9px] uppercase text-amber-200/70 font-mono font-medium tracking-[0.14em]">{role === "admin" ? "ADMIN" : "MECH"}</span>
                    </motion.div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      {enableAnimations ? (
                        ...
                        <h1 className="type-display font-light text-bone-50 text-[clamp(1.6rem,3.8vw,2.6rem)]">Equipment Center</h1>
                      )}
