  ...
  return (
    <div className="rounded-md sm:rounded-lg border border-white/10 bg-black/20 p-2 sm:p-3">
      <div className="flex items-center gap-1.5 sm:gap-2 mb-0.5 sm:mb-1">
        ...
        <span className="text-[9px] sm:text-[10px] uppercase text-white/40 truncate font-mono font-medium tracking-[0.14em]">{label}</span>
      </div>
...
export default function FixesAiPanel({
  ...
  return (
    <motion.div
      ...
      className="rounded-xl sm:rounded-leaf-sm border border-[#B8FF7A]/30 bg-gradient-to-br from-[#121A15]/60 to-[#040605]/80 overflow-hidden mb-4 sm:mb-5"
    >
      {/* Header */}
      <button
      ...
      >
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-[#B8FF7A] to-[#9BEB5B] flex items-center justify-center shadow-lg shadow-[#B8FF7A]/20 flex-shrink-0">
              ...
              {summary && (
                <div className="space-y-4">
                  ...
                  {summary.top_fixed_assets && summary.top_fixed_assets.length > 0 && (
                    <div>
                      <h4 className="text-[10px] uppercase text-white/40 mb-2 font-mono font-medium tracking-[0.14em]">
                  ...
                  <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/5 p-3">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-[10px] uppercase text-emerald-400/70 mb-0.5 font-mono font-medium tracking-[0.14em]">
                          30-Day Spend
                        </p>
                      ...
                      <div className="text-right">
                        <p className="text-[10px] uppercase text-white/40 mb-0.5 font-mono font-medium tracking-[0.14em]">
                          All-Time Total
                        </p>
