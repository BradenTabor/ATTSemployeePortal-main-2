      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 pb-4 pt-4 sm:pt-6">
          ...
          <div className="mb-5 md:mb-6">
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }} className="relative">
              <div className="relative overflow-hidden rounded-2xl md:rounded-3xl border border-white/[0.12] shadow-[0_8px_32px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.1)]" style={{ background: 'linear-gradient(145deg, rgba(192, 132, 252, 0.1) 0%, rgba(45, 27, 78, 0.65) 40%, rgba(10, 5, 19, 0.75) 100%)', backdropFilter: 'blur(24px) saturate(1.6)', WebkitBackdropFilter: 'blur(24px) saturate(1.6)' }}>
                ...
                <div className="relative px-5 py-4 md:px-7 md:py-5">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.4, delay: 0.3 }} className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[#2d1b4e]/60 border border-[#c084fc]/20">
                      ...
                      <span className="text-[9px] uppercase tracking-wider font-semibold text-[#e9d5ff]/70">{role === "admin" ? "ADMIN" : "GEN FOREMAN"}</span>
                    </motion.div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      {enableAnimations ? (
                        ...
                        <h1 className="text-xl sm:text-2xl md:text-3xl font-black tracking-tight bg-gradient-to-r from-white via-[#e9d5ff] to-white/90 bg-clip-text text-transparent">Equipment Logs</h1>
                      )}
          ...
          <ScrollRevealSection delay={0}>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
              {[
                { label: "DVIR Reports", value: stats.totalDvir, icon: Truck, color: "text-[#c084fc]" },
                { label: "Equipment Inspections", value: stats.totalEquip, icon: Wrench, color: "text-[#a855f7]" },
                ...
                <div key={stat.label} className="rounded-2xl border border-[#c084fc]/20 bg-gradient-to-br from-[#2d1b4e]/50 to-[#0a0513]/70 p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <stat.icon className={`w-4 h-4 ${stat.color}`} />
                    <span className="text-[10px] uppercase tracking-wider text-[#e9d5ff]/50">{stat.label}</span>
                  </div>
          ...
          {activeTab === "dvir" && (
            <div className="space-y-4">
              {/* DVIR Filter Bar */}
              <ScrollRevealSection delay={0}>
                <div className="rounded-xl border border-[#c084fc]/15 bg-gradient-to-r from-[#0a0513] to-[#1a0f2e] p-3">
                  <div className="flex flex-col sm:flex-row gap-3">
                      ...
                      {[
                        ...
                        <button
                          ...
                          className={`flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-md text-xs font-medium transition-all ${
                            dvirStatus === id
                              ? "bg-gradient-to-r from-[#c084fc] to-[#a855f7] text-white shadow-md"
                    ...
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full bg-black/30 border border-white/10 rounded-lg pl-8 pr-8 py-2 text-sm text-white placeholder:text-white/30 focus:outline-none focus:ring-1 focus:ring-[#c084fc]/50 transition-all"
                      />
                      {dvirSearch && (
              ...
              <ScrollRevealSection delay={0.1}>
                ...
                {!dvirLoading && !dvirError && (
                  <div className="grid gap-4 lg:grid-cols-3">
                    {/* DVIR List Panel */}
                    <div className="rounded-xl border border-white/10 bg-[#080408] overflow-hidden flex flex-col">
                            ...
                            return (
                              <motion.button
                                ...
                                className={`w-full text-left px-3 py-2.5 transition-all duration-150 flex items-center gap-2.5 group ${
                                  isSelected ? "bg-gradient-to-r from-[#c084fc]/20 to-[#c084fc]/5 border-l-2 border-l-[#c084fc]" : "border-l-2 border-l-transparent hover:bg-white/[0.03]"
                                }`}
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-1.5">
                                    ...
                                    {mechanicFlag && <span className="inline-flex items-center px-1.5 py-0.5 bg-[#c084fc]/20 border border-[#c084fc]/30 rounded text-[9px] text-[#e9d5ff] font-medium">Fixed</span>}
                                  </div>
                                ...
                                <div className="flex items-center gap-2 flex-shrink-0">
                                  ...
                                  <ChevronRight className={`w-4 h-4 transition-all ${isSelected ? "text-[#c084fc]" : "text-white/20 group-hover:text-white/40"}`} />
                                </div>
                              </motion.button>
                            );
                          })
                    ...
                    <div className="lg:col-span-2">
                      <AnimatePresence mode="wait">
                        {!selectedDvir ? (
                          <motion.div key="empty-state" {...(prefersReducedMotion ? detailTransitionReduced : detailTransition)} className="h-full min-h-[300px] rounded-xl border border-white/5 bg-[#050308] p-6 flex flex-col items-center justify-center text-center">
                            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[#c084fc]/10 border border-[#c084fc]/20 mb-3">
                              <ClipboardList className="w-5 h-5 text-[#c084fc]/70" />
                            </div>
                          ...
                          <motion.div key={selectedDvirId} {...(prefersReducedMotion ? detailTransitionReduced : detailTransition)} className="space-y-3">
                            <div className="rounded-xl border border-white/10 bg-[#050308] overflow-hidden">
                              <div className="bg-gradient-to-r from-[#c084fc]/8 to-transparent border-b border-white/5 px-4 py-3">
                                <div className="flex items-center justify-between gap-3">
                                  <div className="flex items-center gap-3 min-w-0">
                                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#c084fc]/20 to-[#a855f7]/10 border border-[#c084fc]/20 flex items-center justify-center flex-shrink-0">
                                      <Truck className="w-5 h-5 text-[#c084fc]" />
                                    </div>
                                  ...
                                  <div className="flex items-center gap-2 flex-shrink-0">
                                    {hasMechanicUpdate(selectedDvir) && (
                                      <span className="inline-flex items-center gap-1 px-2 py-1 bg-[#c084fc]/15 border border-[#c084fc]/25 rounded text-[10px] font-medium text-[#e9d5ff]">
                              ...
                              <div className="px-4 py-4 space-y-4">
                                ...
                                {hasMechanicUpdate(selectedDvir) && (
                                  <div className="rounded-lg border border-[#c084fc]/20 bg-[#c084fc]/5 p-2.5">
                                    <div className="text-[10px] uppercase tracking-wider text-[#c084fc]/70 mb-1.5">Mechanic Fix</div>
                                ...
                                <details className="group">
                                  <summary className="flex items-center justify-between cursor-pointer py-2 text-xs font-medium text-white/60 hover:text-white/80 transition-colors">
                                    <span className="flex items-center gap-1.5"><ListChecks className="w-3.5 h-3.5 text-[#c084fc]/70" />Full Checklist Review</span>
                                ...
                                <details className="group">
                                  <summary className="flex items-center justify-between cursor-pointer py-2 text-xs font-medium text-white/60 hover:text-white/80 transition-colors">
                                    <span className="flex items-center gap-1.5"><Images className="w-3.5 h-3.5 text-[#c084fc]/70" />Photos ({dvirMediaEntries.length})</span>
                                    <ChevronRight className="w-3.5 h-3.5 transition-transform group-open:rotate-90" />
                                  </summary>
                                  {dvirMediaEntries.length === 0 ? <p className="text-[11px] text-white/40 pt-1">No photos uploaded</p> : (
                                    <div className="grid grid-cols-3 gap-2 pt-2">
                                      {dvirMediaEntries.map((media) => (
                                        <a key={media.label} href={media.url} target="_blank" rel="noopener noreferrer" className="group/img block rounded-lg border border-white/5 bg-black/30 overflow-hidden transition-all hover:border-[#c084fc]/30">
                                ...
                                <details className="group">
                                  <summary className="flex items-center justify-between cursor-pointer py-2 text-xs font-medium text-white/60 hover:text-white/80 transition-colors">
                                    <span className="flex items-center gap-1.5"><FileSignature className="w-3.5 h-3.5 text-[#c084fc]/70" />Signatures ({dvirSignatureEntries.length})</span>
                                    <ChevronRight className="w-3.5 h-3.5 transition-transform group-open:rotate-90" />
                                  </summary>
                                  {dvirSignatureEntries.length === 0 ? <p className="text-[11px] text-white/40 pt-1">No signatures</p> : (
                                    <div className="grid grid-cols-2 gap-2 pt-2">
                                      {dvirSignatureEntries.map((sig) => (
                                        <a key={sig.label} href={sig.url} target="_blank" rel="noopener noreferrer" className="rounded-lg border border-white/5 bg-black/30 p-2 transition-all hover:border-[#c084fc]/30">
                ...
                <div className="rounded-xl border border-[#c084fc]/15 bg-gradient-to-r from-[#0a0513] to-[#1a0f2e] p-3">
                  <div className="flex flex-col sm:flex-row gap-3">
                    <div className="relative">
                      <select value={equipmentStatus} onChange={(e) => { setEquipmentStatus(e.target.value as typeof equipmentStatus); setEquipmentPage(1); }} className="w-full sm:w-auto bg-black/30 border border-white/10 rounded-lg px-3 py-2 pr-8 text-sm text-white focus:outline-none focus:ring-1 focus:ring-[#c084fc]/50 appearance-none cursor-pointer transition-all">
                        <option value="attention">Needs Attention</option>
                        <option value="all">All Inspections</option>
                        <option value="passed">Passed Only</option>
                      </select>
                      <ClipboardList className="absolute right-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#c084fc]/60 pointer-events-none" />
                    </div>
                    <div className="relative">
                      <select value={equipmentType} onChange={(e) => { setEquipmentType(e.target.value); setEquipmentPage(1); }} className="w-full sm:w-auto bg-black/30 border border-white/10 rounded-lg px-3 py-2 pr-8 text-sm text-white focus:outline-none focus:ring-1 focus:ring-[#c084fc]/50 appearance-none cursor-pointer transition-all">
                        <option value="">All Types</option>
                        {EQUIPMENT_TYPE_OPTIONS.map((opt) => <option key={opt} value={opt}>{opt}</option>)}
                      </select>
                      <Wrench className="absolute right-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#c084fc]/60 pointer-events-none" />
                    </div>
                    <div className="relative flex-1">
                      <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 w-4 h-4 text-white/30" />
                      <input value={equipmentSearch} onChange={(e) => { setEquipmentSearch(e.target.value); setEquipmentPage(1); }} placeholder="Search equipment or operator..." className="w-full bg-black/30 border border-white/10 rounded-lg pl-8 pr-8 py-2 text-sm text-white placeholder:text-white/30 focus:outline-none focus:ring-1 focus:ring-[#c084fc]/50 transition-all" />
                      {equipmentSearch && (
                ...
                {!equipmentLoading && !equipmentError && (
                  <div className="grid gap-4 lg:grid-cols-3">
                    ...
                    <div className="rounded-xl border border-white/10 bg-[#080408] overflow-hidden flex flex-col">
                      <div className="flex items-center justify-between px-3 py-2 bg-gradient-to-r from-white/5 to-transparent border-b border-white/5">
                        <div className="flex items-center gap-2">
                          <div className={`w-2 h-2 rounded-full ${equipmentStatus === "attention" ? "bg-red-400" : equipmentStatus === "passed" ? "bg-emerald-400" : "bg-[#c084fc]"}`} />
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-1.5">
                                    ...
                                    {hasFix && <span className="inline-flex items-center px-1.5 py-0.5 bg-[#c084fc]/20 border border-[#c084fc]/30 rounded text-[9px] text-[#e9d5ff] font-medium">Fixed</span>}
                                  </div>
                                  <div className="flex items-center gap-2 mt-0.5">
                                ...
                                <ChevronRight className={`w-4 h-4 transition-all flex-shrink-0 ${isSelected ? "text-[#c084fc]" : "text-white/20 group-hover:text-white/40"}`} />
                              </motion.button>
                            );
                          })
                        )}
                            ...
                            <div className="rounded-xl border border-white/10 bg-[#050308] overflow-hidden">
                              <div className="bg-gradient-to-r from-[#c084fc]/8 to-transparent border-b border-white/5 px-4 py-3">
                                <div className="flex items-center justify-between gap-3">
                                  <div className="flex items-center gap-3 min-w-0">
                                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#c084fc]/20 to-[#a855f7]/10 border border-[#c084fc]/20 flex items-center justify-center flex-shrink-0">
                                      <Wrench className="w-5 h-5 text-[#c084fc]" />
                                    </div>
                                    <div className="min-w-0">
                              ...
                              <div className="px-4 py-4 space-y-4">
                                ...
                                <details className="group" open>
                                  <summary className="flex items-center justify-between cursor-pointer py-2 text-xs font-medium text-white/60 hover:text-white/80 transition-colors">
                                    <span className="flex items-center gap-1.5"><ClipboardList className="w-3.5 h-3.5 text-[#c084fc]/70" />Checklists</span>
                                    <ChevronRight className="w-3.5 h-3.5 transition-transform group-open:rotate-90" />
                                  </summary>
                                  <div className="grid gap-2 sm:grid-cols-2 pt-2">
                                    <div className="rounded-lg border border-white/5 bg-white/[0.02] p-2.5">
                                ...
                                <details className="group">
                                  <summary className="flex items-center justify-between cursor-pointer py-2 text-xs font-medium text-white/60 hover:text-white/80 transition-colors">
                                    <span className="flex items-center gap-1.5"><Camera className="w-3.5 h-3.5 text-[#c084fc]/70" />Photos ({equipmentPhotoEntries.length})</span>
                                    <ChevronRight className="w-3.5 h-3.5 transition-transform group-open:rotate-90" />
                                  </summary>
                                  {equipmentPhotoEntries.length === 0 ? <p className="text-[11px] text-white/40 pt-1">No photos uploaded</p> : (
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2">
                                      {equipmentPhotoEntries.map((photo) => (
                                        <a key={photo.label} href={photo.url} target="_blank" rel="noopener noreferrer" className="group/img block rounded-lg border border-white/5 bg-black/30 overflow-hidden transition-all hover:border-[#c084fc]/30">
