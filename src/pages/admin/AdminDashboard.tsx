...
export default function AdminDashboard() {
  ...
  // Announcement composer section (now part of main content)
                ...
                <div className="relative px-5 py-4 md:px-7 md:py-5">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <motion.div
                      ...
                      className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg border border-[#f4c979]/20"
                    >
                      <Megaphone className="w-3 h-3 text-[#f4c979]" />
                      <span className="text-[9px] uppercase tracking-wider font-semibold text-[#f8e5bb]/50">
                        Announcements ready
                      </span>
                    </motion.div>
                  </div>
