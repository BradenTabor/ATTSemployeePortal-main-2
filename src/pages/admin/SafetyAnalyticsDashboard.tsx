/**
 * Safety Analytics Dashboard (Compact)
 * 
 * Unified dashboard combining form compliance rewards and announcement engagement
 */
      ...
      <DashboardLayout title="Safety Analytics" pageHeading>
        <div className="min-h-[50vh] flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-400">Admin or Safety Officer access required.</p>
          </div>
        </div>
      </DashboardLayout>
    );
