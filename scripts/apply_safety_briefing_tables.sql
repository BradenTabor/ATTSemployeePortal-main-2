-- ==========================================================================
-- Apply safety briefing tables (run in Supabase Dashboard → SQL Editor)
-- Use this if "public.safety_briefing_answers" is missing (schema cache).
-- Requires: public.announcements table and public.is_admin() function.
-- ==========================================================================
